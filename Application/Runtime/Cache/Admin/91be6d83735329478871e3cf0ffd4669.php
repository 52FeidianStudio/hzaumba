                            ...
                            <div class="panel panel-default panel-bootstrap-switch">
                                ...
                                <div class="row">                      
                                   <tr>
                                      ...
                                      <th style="text-align:center;">公告链接</th>
                                      <th style="text-align:center;">编辑</th>
                                     
                                   </tr>
                                   <tr>
                                      <td>华中农业大学迎来了快快快快快快快快快你那呢</td>
                                   ...
                                   <tr>
                                      <td>收拾收拾收拾收拾收拾是收拾收拾收拾收拾收拾</td>
                                      <td><a>http://www.hzau.edu.cn</a></td>
                                      <td><input type="submit" class="btn btn-info btn-xs"value="修改"/>&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-info btn-xs"value="删除"/></td>
                                   </tr>
                                   <tr>
                                      <td>的滴滴答答滴滴答答滴滴答答滴滴答答的</td>
                                      <td><a>http://www.hzau.edu.cn</a></td>
                                      <td><input type="submit" class="btn btn-info btn-xs"value="修改"/>&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-info btn-xs"value="删除"/></td>
                                   </tr>
                                   <tr>
                                      <td>是收拾收拾收拾收拾收拾收拾收拾收拾</td>
                                      <td><a>http://www.hzau.edu.cn</a></td>
                                      <td><input type="submit" class="btn btn-info btn-xs"value="修改"/>&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-info btn-xs"value="删除"/></td>
                                   </tr>
                                     ...
                                     <div class="modal-dialog">
                                        <div class="modal-content">
                                           ...
                                           <div class="modal-body">
                                              <input name="" id="" class="form-control" placeholder="请输入公告全称"  type="text"/><br/>
