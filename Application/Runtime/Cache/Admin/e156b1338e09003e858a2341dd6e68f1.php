                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default panel-bootstrap-switch">
                              ...
                              <form  style="width:900px;height:400px;"action="/hzaumba2.0/index.php/admin/Login/update_pw" method="POST" name="jaj"  id="tianjia" onSubmit="return f1();">
                            </br></br>
                           <input name="user" id="" class="form-control" type="text" placeholder="请输入新用户名" style="width:206px;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;margin-left:260px;"><br><br>

                           <input name="password" id="newpassword" class="form-control" type="password" placeholder="请输入新密码" style="width:206px;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;margin-left:260px;"><br><br>

                          <input name="repassword" id="confirmpwd" class="form-control" type="password" placeholder="请确认新密码" style="width:206px;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;margin-left:260px;">
                            <input type="submit" class="btn btn-info right" style="margin-right:300px;margin-top:60px;" value="确定" /></br></br>
                                </form>  
