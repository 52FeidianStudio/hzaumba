                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default panel-bootstrap-switch">
					        	...
					        	<form action="/hzaumba2.0/index.php/Admin/Index/update_home?class=<?php echo ($zd); ?>&name=<?php echo ($name); ?>" method="POST" name="jaj"  id="xiugai" style="display:none">
                           ...
                           <!--新闻中心、通知公告、招生信息、教务信息页面添加页面-->
						      <form action="/hzaumba2.0/index.php/Admin/Index/record_home?class=<?php echo ($zd); ?>&name=<?php echo ($name); ?>" method="POST" name="jaj"  id="tianjia" style="display:none">
