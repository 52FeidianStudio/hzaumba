    ...
    <body class="bootstrap-admin-with-small-navbar">
                             ...
                             <table class="table table-bordered table-striped border table-condensed text-center " >    
                                <div class="row">                      
								  ...
								  <div class="modal fade" id="myModal_update<?php echo ($i); ?>" tabindex="-1" role="dialog" 
									 ...
									 <form action="/hzaumba/index.php/Admin/Index/update_down?class=教师名录" method="POST" name="jaj">
                                 ...
                                 <input type="button" class="btn btn-info right" data-toggle="modal" 
                                   ...
                                   <div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
                                     aria-labelledby="myModalLabel" aria-hidden="true">
                                     <div class="modal-dialog">
									 <form action="/hzaumba/index.php/Admin/Index/record_down?class=教师名录" method="POST" name="jaj">
                                        <div class="modal-content">
                                           <div class="modal-header">
        ...
        <script type="text/javascript">
          ...
          function delete_link(hid){
		      var r=confirm("是否删除");
              if (r==true){
                 window.location.href="/hzaumba/index.php/Admin/Index/delete_down?hid="+hid+"&name=teacher";
              }
		  }
