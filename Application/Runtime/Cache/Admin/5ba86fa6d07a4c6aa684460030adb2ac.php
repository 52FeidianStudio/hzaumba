    ...
    <body class="bootstrap-admin-with-small-navbar">
                                ...
                                <div class="row">                      
                                 ...
                                 <input type="button" class="btn btn-info right" data-toggle="modal" 
                                   ...
                                   <div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
                                     aria-labelledby="myModalLabel" aria-hidden="true">
                                     <div class="modal-dialog">
									 <form action="/hzaumba2.0/index.php/Admin/Index/record_down?class=友情链接" method="POST" name="jaj">
                                        <div class="modal-content">
                                           <div class="modal-header">
        ...
        <script type="text/javascript">
          ...
          function delete_link(hid){
		      var r=confirm("是否删除");
              if (r==true){
                  window.location.href="/hzaumba2.0/index.php/Admin/Index/delete_down?hid="+hid+"&name=links";
              }
		  }
